...
//    Password : Test1234! 
        ...
        WebElement actualUserID= driver.findElement(By.className("navbar-text"));  //WebElement: We are not going to get the
      ...
      // WebElement signOut=driver.findElement(By.linkText("Sign out"));
        ...
        // Find the number of total link on the page
        //a tag creates link on a page. We to find how many a tag on the page
        //To find how many a TAG on the page, we use tagName("a"); locator
